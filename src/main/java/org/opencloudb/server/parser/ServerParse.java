...
public final class ServerParse {
	...
	// HELP' '
	/**
	 *  判断语句中开始位置是否含有Help关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回Help对应值否则返回other对应值 
	 */
	...
	// EXPLAIN' '
	/**
	 *  判断语句中开始位置是否含有EXPLAIN关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回explain对应值否则返回other对应值 
	 */
	...
	// KILL' '
	/**
	 *  判断语句中开始位置是否含有kill关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回kill 对应值否则返回other对应值 
	 */
	...
	// KILL QUERY' '
	/**
	 *  判断语句中开始位置是否含有kill query关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回kill query对应值否则返回other对应值 
	 */
	...
	// BEGIN
	/**
	 *  判断语句中开始位置是否含有begin关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回begin对应值否则返回other对应值 
	 */
	...
	// COMMIT
	/**
	 *  判断语句中开始位置是否含有commit关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回commit对应值否则返回other对应值 
	 */
	...
	// DELETE' '
	/**
	 *  判断语句中开始位置是否含有delete关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回delete对应值否则返回other对应值 
	 */
	...
	// INSERT' '
	/**
	 *  判断语句中开始位置是否含有insert关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回insert对应值否则返回other对应值 
	 */
	...
	// REPLACE' '
	/**
	 *  判断语句中开始位置是否含有replace关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回repalce对应值否则返回other对应值 
	 */
	...
	// ROLLBACK
	/**
	 *  判断语句中开始位置是否含有rollabck关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回rollabck对应值否则返回other对应值 
	 */
	...
	// SAVEPOINT
	/**
	 *  判断语句中开始位置是否含有SAVEPOINT关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回SAVEPOINT对应值否则返回other对应值 
	 */
	...
	// SELECT' '
	/**
	 *  判断语句中开始位置是否含有SELECT关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回SELECT对应值否则返回other对应值 
	 */
	...
	// SHOW' '
	/**
	 *  判断语句中开始位置是否含有SHOW关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回SHOW对应值否则返回other对应值 
	 */
	...
	// START' '
	/**
	 *  判断语句中开始位置是否含有START关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回START对应值否则返回other对应值 
	 */
	...
	// UPDATE' ' | USE' '
	/**
	 *  判断语句中开始位置是否含有UPDATE/USE关键字
	 * @param stmt 执行sql
	 * @param offset 开始位置
	 * @return 如果有返回UPDATE/USE对应值否则返回other对应值 
	 */
